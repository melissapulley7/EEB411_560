...
```{r echo=F}
dat<-read.csv('C:/Users/amolina6/OneDrive - University of Tennessee/Documents/projects/EEB411_560/L2/RootShootRatio_Ma_NEE2021.csv')
```
...
![from Ma et al. (2021) Nature Ecology and Evolution showing the distribution of data points or records used to generate data points analyzed in the paper](C:/Users/amolina6/OneDrive - University of Tennessee/Documents/projects/EEB411_560/figures/L2/Picture1.jpg){} 
...
```
Run it, but mor4 importantly, try to understand what's happening! 
